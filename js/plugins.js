...
// http://backbonejs.org
(function() {
        var n = this, B = n.Backbone, h = [], C = h.push, u = h.slice, D = h.splice, g;
        ...
        var v = /\s+/
            ...
            switch (b.length) {
                ...
                case 1:
                    for (; ++d < e; )
                        (c = a[d]).callback.call(c.ctx, b[0]);
                    break;
                case 2:
                    for (; ++d < e; )
                        (c = a[d]).callback.call(c.ctx, b[0], b[1]);
                    break;
                case 3:
                    for (; ++d < e; )
                        (c = a[d]).callback.call(c.ctx, b[0], b[1], b[2]);
                    break;
                default:
                    for (; ++d < e; )
            ...
            off: function(a, b, c) {
                var d, e, t, g, j, l, k, h;
                if (!this._events || !q(this, "off", a, [b, c]))
                    return this;
                if (!a && !b && !c)
                    return this._events = {},
                        this;
                    ...
                    if (a = g[j],
                        ...
                        if (b || c) {
                            ...
                            for (h = d.length; k < h; k++)
                                e = d[k],
                                (b && b !== e.callback && b !== e.callback._callback || c && c !== e.context) && t.push(e)
                        }
                        this._events[a] = t
                    }
                return this
            ...
            stopListening: function(a, b, c) {
                ...
                if (d) {
                    if (a)
                        a.off(b, "object" === typeof b ? this : c, this),
        ...
        f.extend(r.prototype, h, {
            ...
            set: function(a, b, c) {
                ...
                if (!p) {
                    ...
                    for (d = a.length; b < d; b++)
                        this.trigger("change:" + a[b], this, k[a[b]], c)
                }
                if (j)
                    return this;
                if (!p)
            ...
            changedAttributes: function(a) {
                ...
                var b, c = !1, d = this._changing ? this._previousAttributes : this.attributes, e;
                for (e in a)
            ...
            save: function(a, b, c) {
                ...
                null == a || "object" === typeof a ? (d = a,
                    c = b) : (d = {})[a] = b;
                if (d && (!c || !c.wait) && !this.set(d, c))
                    return !1;
                c = f.extend({
                    validate: !0
                }, c);
        ...
        f.extend(s.prototype, h, {
            ...
            add: function(a, b) {
                ...
                for (d = a.length; c < d; c++)
                    (e = this._prepareModel(g = a[c], b)) ? (p = this.get(e)) ? b.merge && (p.set(g === e ? e.attributes : g, b),
                    h && (!j && p.hasChanged(m)) && (j = !0)) : (l.push(e),
                        e.on("all", this._onModelEvent, this),
                        this._byId[e.cid] = e,
                    null != e.id && (this._byId[e.id] = e)) : this.trigger("invalid", this, g, b);
                l.length && (h && (j = !0),
            ...
            update: function(a, b) {
                ...
                if (b.remove) {
                    d = 0;
                    for (e = this.models.length; d < e; d++)
                        c = this.models[d],
                        l[c.cid] || j.push(c)
                }
        ...
        f.extend(y.prototype, h, {
            ...
            _routeToRegExp: function(a) {
                a = a.replace(H, "\\$&").replace(E, "(?:$1)?").replace(F, function(a, c) {
                    return c ? a : "([^/]+)"
                }).replace(G, "(.*?)");
                return RegExp("^" + a + "$")
            },
        ...
        f.extend(m.prototype, h, {
            ...
            start: function(a) {
                ...
                b && this._wantsHashChange && (this.iframe = g.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow,
                    this.navigate(a));
                if (this._hasPushState)
                    g.$(window).on("popstate", this.checkUrl);
                ...
                if (this._wantsHashChange && this._wantsPushState && !this._hasPushState && !b)
                    return this.fragment = this.getFragment(null, !0),
                        ...
                        !0;
                this._wantsPushState && (this._hasPushState && b && a.hash) && (this.fragment = this.getHash().replace(z, ""),
...
(function($) {
    ...
    $.fn.fitVids = function(options) {
        ...
        return this.each(function() {
            var selectors = ["iframe:not([src*='soundcloud.com'])", "object", "embed"];
            ...
            $allVideos.each(function() {
                ...
                if (!$this.hasClass('highlight') && !$(document.body).hasClass('template-index')) {
                    $this.parent('.fluid-width-video-wrapper').wrap('<div class="max-width-video-wrapper"></div>').parent('.max-width-video-wrapper').css({
                        'maxWidth': 640,
                        'marginLeft': 'auto',
                        'marginRight': 'auto'
                    });
...
// Grouped Content
!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.GroupedContent = t()
}(this, function() {
    "use strict";
    function e(e, t, n) {
        var i = 0;
    ...
    function c(e) {
        for (var t = ["H1", "H2", "H3", "H4", "H5", "H6"], n = t.indexOf(e.tagName), i = [], r = e.nextElementSibling; null !== r && (-1 === t.indexOf(r.tagName) || t.indexOf(r.tagName) > n); )
            i.push(r),
                r = r.nextElementSibling;
        return i
    }
    function s(e, t) {
        for (var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = ["H1", "H2", "H3", "H4", "H5", "H6"], r = i.indexOf(e.tagName), a = [], o = 5, u = 0; u < t.length; u += 1) {
            var g = t[u]
                , l = i.indexOf(g.tagName);
            if (-1 !== l && l < o && (o = l),
            n && -1 !== l && l <= o || !n && -1 !== l && l === r + 1) {
                var d = c(g)
                    , h = {
                    el: g,
                    content: d,
    ...
    function u(e, t, n) {
        for (var i = [], r = [], a = 0, o = 0; o < e.length; o += 1)
            -1 === t.indexOf(o) && (r.push(e[o]),
                a += 1,
                o !== e.length - 1 && e[o].el.tagName !== e[o + 1].el.tagName && t.indexOf(o + 1) ? (r = [],
                    a = 0) : 0 !== o && e[o].el.tagName !== e[o - 1].el.tagName && (r.pop(),
                (a -= 1) >= n && i.push(r),
                    r = [e[o]],
                    a = 1));
        return a >= n && i.push(r),
    ...
    function g(e) {
        ...
        for (var a = 0; a < e.length; a += 1) {
            ...
            c = i.appendChild(c),
                s = r.appendChild(s);
            for (var u = 0; u < o.content.length; u += 1)
                s.appendChild(o.content[u]);
            t.push({
                trigger: c,
                content: s
            })
    ...
    function l(e) {
        ...
        for (var o = u(t, n, 3), c = 0; c < o.length; c += 1)
            i.push(g(o[c]));
        return i
    }
    function d(e) {
    ...
    function h(e) {
        for (var t = [], n = e.querySelectorAll(".tabs"), i = 0; i < n.length; i += 1) {
            var r = n[i].children
                , a = n[i].nextElementSibling.children;
            if (r.length === a.length)
                for (var o = t.push({
                    triggers: n[i],
                    contents: n[i].nextElementSibling,
                    pairings: []
                }) - 1, c = 0; c < r.length; c += 1) {
                    var s = {
                        trigger: r[c],
                        content: a[c]
                    };
    ...
    function p(e) {
        return arguments.length > 1 && void 0 !== arguments[1] && arguments[1] ? d(e) : h(e)
    }
    var f = {
        init: function(n) {
            var i = n.triggers
            ...
            i.setAttribute("role", "tablist"),
                e(r, function(i, r) {
                    i.trigger.setAttribute("role", "tab"),
                        i.trigger.setAttribute("aria-controls", n.namespace + "-" + n.id + "-" + r + "-content"),
                    i.trigger.children.length > 0 && e(i.trigger.children, function(e) {
                        e.setAttribute("tabIndex", "-1")
                    }),
                        t(i.trigger, "active") ? (i.trigger.setAttribute("aria-selected", "true"),
                            i.trigger.setAttribute("tabIndex", "0")) : i.trigger.setAttribute("tabIndex", "-1"),
                        i.content.id = n.namespace + "-" + n.id + "-" + r + "-content",
                        i.content.setAttribute("role", "tabpanel"),
                    t(i.content, "active") || i.content.setAttribute("aria-hidden", "true")
                })
        },
        update: function(n) {
            e(n.pairings, function(e) {
                e.trigger.removeAttribute("aria-selected"),
                    e.content.removeAttribute("aria-hidden"),
                    t(e.trigger, "active") ? (e.trigger.setAttribute("aria-selected", "true"),
                        e.trigger.setAttribute("tabIndex", "0")) : e.trigger.setAttribute("tabIndex", "-1"),
                t(e.content, "active") || e.content.setAttribute("aria-hidden", "true")
            })
        }
    }
        , v = (function() {
        ...
        function r(e) {
            v(this, r),
                this.groupedContent = e,
                this.pairings = e.pairings,
                this.events = [],
                this._handleKeydown = this._handleKeydown.bind(this),
                this._handleClick = this._handleClick.bind(this),
                this._init(),
                f.init(this.groupedContent)
        }
        return x(r, [{
            key: "unload",
            value: function() {
                e(this.events, function(e) {
            ...
            value: function() {
                var i = this
                    , r = !1;
                e(this.pairings, function(e) {
                    var n = e.trigger;
                    t(n, "active") && (r = !0),
                        n.addEventListener("keydown", i._handleKeydown),
                        n.addEventListener("click", i._handleClick),
                        i.events.push({
                            trigger: n,
                            type: "keydown",
                            fn: i._handleKeydown
                ...
                r || (n(this.pairings[0].trigger, "active"),
                    n(this.pairings[0].content, "active"))
            }
        }, {
            key: "_handleKeydown",
            value: function(t) {
                var r = t.currentTarget
                    , o = a(this.pairings, r)
                    , c = this.pairings.indexOf(o)
                    , s = c - 1 < 0 ? this.pairings.length - 1 : c - 1
                    , u = c + 1 >= this.pairings.length ? 0 : c + 1
                    , g = null;
                switch (t.key) {
                    case "ArrowLeft":
                        g = this.pairings[s];
        ...
        init: function(n) {
            e(n.pairings, function(i, r) {
                ...
                i.trigger.children.length > 0 && e(i.trigger.children, function(e) {
                    ...
                    t(i.trigger, "active") ? i.trigger.setAttribute("aria-expanded", "true") : i.trigger.setAttribute("aria-expanded", "false"),
                    i.content.id = n.namespace + "-" + n.id + "-" + r + "-content",
                t(i.content, "active") || i.content.setAttribute("aria-hidden", "true")
            })
        },
        update: function(n) {
            e(n.pairings, function(e) {
                e.content.removeAttribute("aria-hidden"),
                    t(e.trigger, "active") ? e.trigger.setAttribute("aria-expanded", "true") : e.trigger.setAttribute("aria-expanded", "false"),
                t(e.content, "active") || e.content.setAttribute("aria-hidden", "true")
            })
        }
    }
            ...
            value: function() {
                ...
                e(this.pairings, function(e) {
                    ...
                    n.parentNode.insertBefore(i, n.nextSibling),
                        n.addEventListener("keydown", t._handleKeydown),
                        n.addEventListener("click", t._handleClick),
                        t.events.push({
                            trigger: n,
                            type: "keydown",
                            fn: t._handleKeydown
    ...
    return function() {
        function t(i) {
            ...
            var c = a.layout || "tabs";
            e(p(i, !!a.intelliparse), function(t) {
                var i = o()
                    , a = null
                    , s = document.createElement("div");
                switch (s = t.triggers.parentNode.insertBefore(s, t.triggers.nextSibling),
                    n(s, r.namespace),
                    n(s, r.namespace + "-layout-" + c),
                    s.appendChild(t.triggers),
                    s.appendChild(t.contents),
                    t.namespace = r.namespace,
                    t.id = i,
                    t.triggers.id = r.namespace + "-" + i + "-triggers",
                    t.contents.id = r.namespace + "-" + i + "-contents",
                    n(t.triggers, r.namespace + "-triggers"),
                    n(t.contents, r.namespace + "-contents"),
                    e(t.pairings, function(e) {
                        n(e.trigger, r.namespace + "-trigger"),
                            n(e.content, r.namespace + "-content")
                    }),
                    c) {
                    case "accordion":
                        a = new y(t);
                ...
                r.groupedContentInstances.push({
                    groupedContent: t,
                    instance: a
                })
            })
        ...
        return x(t, [{
            key: "unload",
            value: function() {
                e(this.groupedContentInstances, function(e) {
                    e.instance.unload()
                })
            }
        }]),
